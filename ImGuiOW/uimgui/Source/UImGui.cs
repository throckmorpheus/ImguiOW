...
namespace UImGui
{
	...
	public class UImGui : MonoBehaviour
	{
		...
		public void SetShader(Shader shader)
		{
			...
			{
				enabled = false;
				throw new System.Exception($"Fail: {shader} is null.");
			}

			_shaders ??= new();
			_shaders.Shader ??= new();
			_shaders.Shader.Procedural = shader;
			_shaders.PropertyNames ??= new() { Texture = "_Texture", Vertices = "_Vertices", BaseVertex = "_BaseVertex" };
		}
