...
namespace UImGui
{
	...
	internal struct FontConfig
	{
		...
		public void ApplyTo(ImFontConfigPtr im)
		{
			...
			im.GlyphExtraSpacing = GlyphExtraSpacing.ToSystemVector();
			im.GlyphOffset = GlyphOffset.ToSystemVector();
		...
		public void SetFrom(ImFontConfigPtr im)
		{
			...
			GlyphExtraSpacing = im.GlyphExtraSpacing.ToUnityVector();
			GlyphOffset = im.GlyphOffset.ToUnityVector();
